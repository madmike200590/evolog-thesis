...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
  ...
  \Keywords{answer set programming\sep lazy-grounding\sep knowledge representation\sep modularization\sep logic programming}               % The document's keywords in the document properties (separated by '\sep ').
