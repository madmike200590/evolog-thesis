...
In this Section, illustrate the operation of the graph coloring application along with the resulting output files and answer sets.\todo{rephrase, it's actually just one due to space constraints.}
